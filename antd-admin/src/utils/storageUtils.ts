...
const USER_TOKEN_EXPIRES = 'expires_at'
...
export const storageUtils = {
    ...
    saveExpiresAt(at: number) {
        localStorage.setItem(USER_TOKEN_EXPIRES, at.toString())
    },
    getExpiresAt() {
    ...
    getTreeMenu(): string[] {
        const treeMenu = localStorage.getItem(TREE_MENU);
